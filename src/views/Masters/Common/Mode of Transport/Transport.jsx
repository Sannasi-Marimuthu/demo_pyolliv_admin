...
export default function PropertyType() {
  ...
  const columns = [
    { title: 'Mode of Transport', dataIndex: 'Transport', key: 'Transport' },
    {
      title: 'Inactive',
      dataIndex: 'Status',
      key: 'Status',
  ...
  const id = sessionStorage.getItem('Transport')
  const handlesubmit = () => {
    try {
      if (!transport) {
      ...
      const Transport = transport?.toString().trim() || ''
              ...
              <div className="admin-col">
                <div className="inputs">
                  ...
                  <Input
                    maxLength={30}
                    className="inputbox"
                    placeholder="Enter Near by Places"
                    value={transport}
                    onChange={(e) => {
